...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('admin.addnotice')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-sign-out-alt mr-1 pr-1"></i>Add Notice</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('admin.search')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-sign-out-alt mr-1 pr-1"></i>Search User</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('admin.nosearch')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-sign-out-alt mr-1 pr-1"></i>Notice</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{ route('admin.reset') }}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-sign-out-alt mr-1 pr-1"></i>Reset</a></li>
        ...
        <!-- Footer-->
        <footer class="footer text-center" id="foot">
            <div class="container">
                <div class="row">
                    <!-- Footer Location-->
