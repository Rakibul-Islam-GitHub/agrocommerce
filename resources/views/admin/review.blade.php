...
<html lang="en">
    ...
    @csrf
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('admin.addnotice')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-user mr-1 pr-1"></i>Add Notice</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('npdf')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-user mr-1 pr-1"></i>Download</a></li>
                ...
                <table border="1" width="100%" align="center">
                    <thead>
                        <tr>
                            ...
                            <th style="color:red">Produce Id</th>
                            <th style="color:red">Seller Id</th>
		...
		<tr>
			<td>{{$review[$i]['customerid']}}</td>
            <td>{{$review[$i]['productid']}}</td>
            <td>{{$review[$i]['sellerid']}}</td>
            <td>{{$review[$i]['review']}}</td>
			<td>{{$review[$i]['date']}}</td>
			<td>
				<a href="{{route('review.delete', $review[$i]['rid'])}}">Delete</a> 
			</td>
		</tr>
		@endfor
                </table>
