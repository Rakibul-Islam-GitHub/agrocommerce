            ...
            <div class="container">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="exampleInputUsername1" aria-describedby="emailHelp" name="password" value="">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="exampleInputUsername1" aria-describedby="emailHelp" name="repassword" value="">
                        <small id="emailHelp" class="form-text text-muted"></small>
                        @error('uid')	
								<span style="color: red">*{{ $message }}</span><br><br>
						@enderror
