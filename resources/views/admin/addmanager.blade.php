            ...
            <div class="container">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" aria-describedby="emailHelp" name="username" placeholder="Enter username">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="phone" placeholder="Enter Phone Number">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="user_role" value="manager">
                        <small id="emailHelp" class="form-text text-muted"></small>
                        @error('user-role')	
								<span style="color: red">*{{ $message }}</span><br><br>
						@enderror
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="salary" value="">
                        <small id="emailHelp" class="form-text text-muted"></small>
                        @error('salary')	
								<span style="color: red">*{{ $message }}</span><br><br>
						@enderror
