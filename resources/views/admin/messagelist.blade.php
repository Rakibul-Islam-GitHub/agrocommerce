...
<html lang="en">
    ...
    @csrf
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('admin.sendmessage')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-user mr-1 pr-1"></i>Send Message</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{route('npdf')}}" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"><i class="fas fa-user mr-1 pr-1"></i></a></li>
		...
		<tr>
			<td>{{$message[$i]['sender_email']}}</td>
            <td>{{$message[$i]['message']}}</td>
            <td><a href="{{route('admin.sendmessage', $message[$i]['sender_email'])}}">Reply</a></td>
		</tr>
		@endfor
                </table>
               </div>
