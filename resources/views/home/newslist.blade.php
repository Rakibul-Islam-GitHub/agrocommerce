...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <tr>
            <td>{{$users[$i]['newsid']}}</td>
            <td>{{$users[$i]['date']}}</td>
            <td>{{$users[$i]['headline']}}</td>
            <td>{{$users[$i]['detail']}}</td>
            <td>
                <a href="/news/edit/{{$users[$i]['newsid']}}">Edit</a> |
                <a href="/news/delete/{{$users[$i]['newsid']}}">Delete</a> |
                <a href="/news/pdf/{{$users[$i]['newsid']}}">Pdf</a>
            </td>
        </tr>
        @endfor
    </table>
    <div class="my-class">
        <a href="/news/create" class="center">New News</a>
        </div>
        </section>
        <!-- Footer-->
