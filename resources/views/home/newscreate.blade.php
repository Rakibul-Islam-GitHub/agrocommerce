        ...
        <section class="page-section" id="contact">
           ...
           <form method="post" enctype="multipart/form-data" class="center">
			...
			<table class="center">
				<tr>
					<td>Date</td>
					<td><input type="text" name="date" class="center"></td>
				</tr>
				<tr>
					<td>Headline</td>
					<td><input type="text" name="headline" class="center"></td>
				</tr>
				<tr>
					<td>Details</td>
					<td><input type="text" name="detail" class="center"></td>
				</tr>
				<tr>
					<td></td>
					<td><input type="submit" name="submit" value="create" class="center"></td>
				</tr>
			</table>
			</fieldset>
		</form>
